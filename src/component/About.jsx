                            ...
                            <div className="col-md-6 col-lg-6">
                                <ul className="list-group">
                                    <li className="list-group-item">
                                        ...
                                        <strong>Email</strong>
                                        <span className="text-success float-end">nareshnaik209080@gmail.com</span>
                                    </li>
                                    <li className="list-group-item">
                                        <i className="b bi-phone-fill me-2"></i>
                                        <strong>Mobile</strong>
                                        <span className="text-success float-end">+91-8688656875</span>
                                    </li>
                                    <li className="list-group-item">
                            ...
                            <div className="col-md-6 col-lg-6">
                                <ul className="list-group">
                                    <li className="list-group-item">
                                        ...
                                        <span className="text-success float-end">Bio-Technology</span>
                                    </li>
                                    <li className="list-group-item">
